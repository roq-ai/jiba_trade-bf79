...
-- AddForeignKey
ALTER TABLE "progress" ADD CONSTRAINT "progress_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
